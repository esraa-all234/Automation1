...
Random rand = new Random(); 
	...
	// we added to add randeom after the namers to prevent the redundancy
...
String ExpectedTextForTheLogout="ACCOUNT LOGOUT"
;
String TheLogoutMessage ="You have been soso logged off your account. It is now safe to leave the computer.";
